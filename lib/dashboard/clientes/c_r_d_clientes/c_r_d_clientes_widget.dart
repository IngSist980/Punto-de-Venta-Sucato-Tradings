...
import '/dashboard/clientes/update_cliente/update_cliente_widget.dart';
...
import 'c_r_d_clientes_model.dart';
export 'c_r_d_clientes_model.dart';

///
///
class CRDClientesWidget extends StatefulWidget {
  const CRDClientesWidget({super.key});

  static String routeName = 'CRDClientes';
  static String routePath = '/cRDClientes';

  @override
  State<CRDClientesWidget> createState() => _CRDClientesWidgetState();
}

class _CRDClientesWidgetState extends State<CRDClientesWidget>
    with TickerProviderStateMixin {
  late CRDClientesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CRDClientesModel());
                                          ...
                                          Expanded(
                                            child: StreamBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<ClientesFrecuentesRecord>
                                                    flexClientesFrecuentesRecordList =
                                                    snapshot.data!;
                                                if (flexClientesFrecuentesRecordList
                                                    .isEmpty) {
                                                  return Center(
                                                ...
                                                return Flex(
                                                  ...
                                                  children: List.generate(
                                                      flexClientesFrecuentesRecordList
                                                          .length, (flexIndex) {
                                                    final flexClientesFrecuentesRecord =
                                                        flexClientesFrecuentesRecordList[
                                                            flexIndex];
                                                    return Visibility(
                                                                ...
                                                                SlidableAction(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (confirmDialogResponse) {
                                                                      await flexClientesFrecuentesRecord
                                                                          .reference
                                                                          .delete();
                                                                      await actions
                                                                          ...
                                                                          return Dialog(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: UpdateClienteWidget(
                                                                                clienteDoc: flexClientesFrecuentesRecord,
                                                                                isEdit: true,
                                                                              ),
                                                                            ),
                                                                          );
