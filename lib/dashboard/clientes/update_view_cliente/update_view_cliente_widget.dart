...
import 'update_view_cliente_model.dart';
export 'update_view_cliente_model.dart';

class UpdateViewClienteWidget extends StatefulWidget {
  const UpdateViewClienteWidget({
    super.key,
    required this.clienteDoc,
    bool? isEdit,
  }) : this.isEdit = isEdit ?? false;

  final ClientesFrecuentesRecord? clienteDoc;
  final bool isEdit;

  @override
  State<UpdateViewClienteWidget> createState() =>
      _UpdateViewClienteWidgetState();
}

class _UpdateViewClienteWidgetState extends State<UpdateViewClienteWidget> {
  late UpdateViewClienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateViewClienteModel());

    _model.nombreTextController ??=
        TextEditingController(text: widget.clienteDoc?.nombreCompleto);
    _model.nombreFocusNode ??= FocusNode();

    _model.codeTextController ??=
        TextEditingController(text: widget.clienteDoc?.codigo);
    _model.codeFocusNode ??= FocusNode();

    _model.socialTextController ??=
        TextEditingController(text: widget.clienteDoc?.razonSocial);
    _model.socialFocusNode ??= FocusNode();

    _model.direccionTextController ??=
        TextEditingController(text: widget.clienteDoc?.direccion);
    _model.direccionFocusNode ??= FocusNode();

    _model.juridicaTextController ??=
        TextEditingController(text: widget.clienteDoc?.cedulaJuridica);
    _model.juridicaFocusNode ??= FocusNode();

    _model.telefonoTextController ??=
        TextEditingController(text: widget.clienteDoc?.telefono);
    _model.telefonoFocusNode ??= FocusNode();

    _model.telefonoMask = MaskTextInputFormatter(mask: '+506 ########');
    _model.telefono2TextController ??=
        TextEditingController(text: widget.clienteDoc?.telefono2);
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (widget.isEdit)
                    Text(
                      'Por favor ingrese todos lo datos para actualizar un cliente frecuente',
                      textAlign: TextAlign.center,
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.inter(
                  ...
                  TextFormField(
                    controller: _model.juridicaTextController,
                    focusNode: _model.juridicaFocusNode,
                    autofocus: false,
                    textInputAction: TextInputAction.next,
                    readOnly: !widget.isEdit,
                    obscureText: false,
                    ...
                    cursorColor: FlutterFlowTheme.of(context).primary,
                    validator: _model.juridicaTextControllerValidator
                        .asValidator(context),
                  ),
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: TextFormField(
                          ...
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Teléfono de Contacto 2 *',
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  font: GoogleFonts.inter(
                  ...
                  FlutterFlowDropDown<String>(
                    controller: _model.dropDownCategoriaValueController ??=
                      ...
                      _model.dropDownCategoriaValue ??=
                          widget.clienteDoc?.categoria,
                    ),
                    options: ['Corporativo', 'PYME', 'Gobierno', 'Educación'],
                    onChanged: (val) =>
                  ...
                  if (widget.isEdit)
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        await widget.clienteDoc!.reference.update({
                          ...createClientesFrecuentesRecordData(
                            razonSocial: _model.socialTextController.text,
                            cedulaJuridica: _model.juridicaTextController.text,
                            ...
                            fechaEdicion: getCurrentTimestamp,
                            telefono2: _model.telefono2TextController.text,
                          ),
                          ...mapToFirestore(
                            {
                              'Log': FieldValue.arrayUnion([
                                getLogEdicionClientesFirestoreData(
                                  updateLogEdicionClientesStruct(
                                    LogEdicionClientesStruct(
                                      fechaEdicion: getCurrentTimestamp,
                                      razonSocial:
                                          _model.socialTextController.text,
                                      cedulaJuridica:
                                          _model.juridicaTextController.text,
                                      direccion:
