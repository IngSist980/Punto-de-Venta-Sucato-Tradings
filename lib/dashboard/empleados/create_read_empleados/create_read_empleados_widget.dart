...
import '/dashboard/empleados/update_view_empleados/update_view_empleados_widget.dart';
...
import 'create_read_empleados_model.dart';
export 'create_read_empleados_model.dart';

///
///
class CreateReadEmpleadosWidget extends StatefulWidget {
  const CreateReadEmpleadosWidget({super.key});

  static String routeName = 'CreateReadEmpleados';
  static String routePath = '/createReadEmpleados';

  @override
  State<CreateReadEmpleadosWidget> createState() =>
      _CreateReadEmpleadosWidgetState();
}

class _CreateReadEmpleadosWidgetState extends State<CreateReadEmpleadosWidget>
    with TickerProviderStateMixin {
  late CreateReadEmpleadosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateReadEmpleadosModel());
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                return Flex(
                                                  ...
                                                  children: List.generate(
                                                      flexUserRecordList.length,
                                                      (flexIndex) {
                                                    final flexUserRecord =
                                                        flexUserRecordList[
                                                            flexIndex];
                                                    return Visibility(
                                                      visible:
                                                          ...
                                                          child: Slidable(
                                                                    ...
                                                                    var confirmDialogResponse =
                                                                        await showDialog<bool>(
                                                                              ...
                                                                              builder: (alertDialogContext) {
                                                                                return AlertDialog(
                                                                                  title: Text('Eliminar'),
                                                                                  content: Text('¿Seguro que quieres eliminar el empleado?'),
                                                                                  actions: [
                                                                                    TextButton(
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return Dialog(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: UpdateViewEmpleadosWidget(
                                                                                empleadoDoc: flexUserRecord,
                                                                                isEdit: true,
                                                                              ),
                                                                            ),
                                                                          );
                                                            ...
                                                            child: Material(
                                                              ...
                                                              child: ListTile(
                                                                ...
                                                                subtitle: Text(
                                                                  '${flexUserRecord.email} - ${flexUserRecord.rol}',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .labelMedium
                                                                      .override(
                                    ...
                                    builder: (context) => Form(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              'Por favor ingrese todos lo datos para agregar un empleado',
                                                ...
                                                if (selectedMedia != null &&
                                                  ...
                                                  try {
                                                    ...
                                                    ScaffoldMessenger.of(
                                                            context)
                                                        .hideCurrentSnackBar();
                                                    _model.isDataUploading_uploadDataHi1 =
                                                        false;
                                                  }
                                              ...
                                              child: Container(
                                                ...
                                                child: Image.network(
                                                  _model.uploadedFileUrl_uploadDataHi1 !=
                                                              ''
                                                      ? _model
                                                          .uploadedFileUrl_uploadDataHi1
                                                      : 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwzfHx1c2VyfGVufDB8fHx8MTc1NzkzODQ0OHww&ixlib=rb-4.1.0&q=80&w=1080',
                                                  fit: BoxFit.cover,
                                                ),
                                              ),
                                            ),
                                              ...
                                              onPressed: () async {
                                                ...
                                                if ((_model.apiResult1u5
                                                  ...
                                                  await actions
                                                    ...
                                                    context,
                                                    'Creado',
                                                    'Se ha creado correctamente el empleado',
                                                    'success',
                                                  );
                                                  safeSetState(() {
                                                    _model.nombreTextController
