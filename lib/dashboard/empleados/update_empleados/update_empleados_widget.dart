...
import 'update_empleados_model.dart';
export 'update_empleados_model.dart';

class UpdateEmpleadosWidget extends StatefulWidget {
  const UpdateEmpleadosWidget({
    super.key,
    required this.clienteDoc,
    bool? isEdit,
  }) : this.isEdit = isEdit ?? false;

  final UserRecord? clienteDoc;
  final bool isEdit;

  @override
  State<UpdateEmpleadosWidget> createState() => _UpdateEmpleadosWidgetState();
}

class _UpdateEmpleadosWidgetState extends State<UpdateEmpleadosWidget> {
  late UpdateEmpleadosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateEmpleadosModel());

    _model.nombreTextController ??=
        TextEditingController(text: widget.clienteDoc?.displayName);
    ...
    _model.creacionTextController ??= TextEditingController(
        text: widget.clienteDoc?.createdTime?.toString());
    _model.creacionFocusNode ??= FocusNode();

    _model.telefonoTextController ??=
        TextEditingController(text: widget.clienteDoc?.phoneNumber);
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (widget.isEdit)
                    Text(
                      'Por favor ingrese todos lo datos para crear un empleado.',
                      textAlign: TextAlign.center,
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.inter(
                  ...
                  FlutterFlowDropDown<String>(
                    controller: _model.dropDownRolValueController ??=
                      ...
                      _model.dropDownRolValue ??= widget.clienteDoc?.rol,
                    ),
                    options: [
                      'Admin',
                      'Gerente',
