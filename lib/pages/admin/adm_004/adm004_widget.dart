...
class Adm004Widget extends StatefulWidget {
  ...
  static String routeName = 'ADM-004';
  static String routePath = '/adm004';

  @override
  State<Adm004Widget> createState() => _Adm004WidgetState();
}

class _Adm004WidgetState extends State<Adm004Widget> {
  late Adm004Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Adm004Model());
