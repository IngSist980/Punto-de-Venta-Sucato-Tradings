...
class UpdateViewProveedorModel
  ...
  String? _encargadoTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Nombre Encargado es requerido';
    }
  ...
  String? _productoTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
  ...
  FocusNode? plazoFocusNode;
  TextEditingController? plazoTextController;
  String? Function(BuildContext, String?)? plazoTextControllerValidator;
  ...
  void initState(BuildContext context) {
    ...
    productoTextControllerValidator = _productoTextControllerValidator;
  }
  ...
  void dispose() {
    ...
    plazoFocusNode?.dispose();
    plazoTextController?.dispose();
  }
}
