...
class _TiendaState extends State<Tienda> {
  ...
  void _mostrarImagenAmpliada(String imageUrl) {
    setState(() {
      imagenAmpliadaUrl = imageUrl;
    });
  }

  void _cerrarImagenAmpliada() {
    setState(() {
      ...
      child: Column(
        ...
        children: [
          ...
          if (producto.imagen != null && producto.imagen!.isNotEmpty)
            GestureDetector(
              onTap: () {
                _mostrarImagenAmpliada(producto.imagen!);
              },
              child: Container(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'Proveedor: ${producto.proveedorName}',
                  style: FlutterFlowTheme.of(context).bodySmall.override(
                        fontFamily: 'Readex Pro',
                        color: FlutterFlowTheme.of(context).secondaryText,
                        fontSize: 10,
  ...
  Widget _buildImagenAmpliada() {
    if (imagenAmpliadaUrl == null) return SizedBox.shrink();

    return GestureDetector(
      onTap: _cerrarImagenAmpliada,
      child: Container(
            ...
            children: [
              ...
              Positioned(
                ...
                child: IconButton(
                  ...
                  onPressed: _cerrarImagenAmpliada,
                ),
              ),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        if (imagenAmpliadaUrl != null) _buildImagenAmpliada(),
      ],
    );
  }
