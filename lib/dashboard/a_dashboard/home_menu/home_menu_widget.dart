...
class HomeMenuWidget extends StatefulWidget {
  const HomeMenuWidget({
    super.key,
    required this.moduloAVer,
    required this.docAjustesApp,
  });

  final Future Function(String moduloNombre)? moduloAVer;
  final DocumentReference? docAjustesApp;
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Expanded(
                      child: Lottie.asset(
                        'assets/jsons/shopping_Ecommerce.json',
                    ...
                    builder: (dialogContext) {
                      return Dialog(
                        ...
                        child: RootPasswordWidget(
                          mensaje:
                              'Para cerrar caja es necesario la clave de acceso del administrador',
                          isCorrect: () async {
                            await widget.docAjustesApp!
                                .update(createAjustesAppRecordData(
                              cajaAbierta: false,
                            ));
                            FFAppState().fechaCierreCaja = getCurrentTimestamp;
                            safeSetState(() {});
                            await actions.customToastification(
                              context,
                              'Éxito',
                              'Se ha cerrado la caja correctamente',
                              'success',
                            );

                            context.pushNamed(
                              CajaCerradaWidget.routeName,
                              queryParameters: {
                                'refAjustesApp': serializeParam(
                                  widget.docAjustesApp,
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                fit: BoxFit.cover,
                                image: Image.network(
                                  'https://blog.epayco.com/wp-content/uploads/2021/01/8.-Sep-La-importancia-de-una-orden-de-compra-para-los-negocios-online-scaled.jpg',
                                ).image,
                              ),
                              borderRadius: BorderRadius.only(
                                bottomLeft: Radius.circular(0.0),
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                fit: BoxFit.cover,
                                image: Image.network(
                                  'https://images.unsplash.com/photo-1526628953301-3e589a6a8b74?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw0fHxyZXBvcnR8ZW58MHx8fHwxNzU4NDM1MjI1fDA&ixlib=rb-4.1.0&q=80&w=1080',
                                ).image,
                              ),
                              borderRadius: BorderRadius.only(
                                bottomLeft: Radius.circular(0.0),
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                fit: BoxFit.cover,
                                image: Image.network(
                                  'https://images.unsplash.com/photo-1628348068343-c6a848d2b6dd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw3fHxyZXBvcnR8ZW58MHx8fHwxNzU5MzY0MjQ4fDA&ixlib=rb-4.1.0&q=80&w=1080',
                                ).image,
                              ),
                              borderRadius: BorderRadius.only(
                                bottomLeft: Radius.circular(0.0),
                            ...
                            children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.descuentoTextController,
                                        ...
                                        enableInteractiveSelection: true,
                                        validator: _model
                                            .descuentoTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                    Row(
                                      ...
                                      children: [
                                        Theme(
                                          ...
                                          child: Checkbox(
                                            value: _model.usoValue ??= true,
                                            onChanged: (newValue) async {
                                              safeSetState(() =>
                                                  _model.usoValue = newValue!);
                                            },
                              ...
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  await PromocionesDescuentosRecord.collection
                                      .doc()
                                      .set(
                                          createPromocionesDescuentosRecordData(
                                        code: _model.codigoTextController.text,
                                        descuento: int.tryParse(_model
                                            .descuentoTextController.text),
                                        unSoloUso: _model.usoValue,
                                      ));
                                  safeSetState(() {
                                    _model.codigoTextController?.clear();
                                    _model.descuentoTextController?.clear();
                                  });
                                  await actions.customToastification(
                                    context,
                                    'Éxito',
