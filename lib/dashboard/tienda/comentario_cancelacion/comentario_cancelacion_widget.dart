...
import 'comentario_cancelacion_model.dart';
export 'comentario_cancelacion_model.dart';

class ComentarioCancelacionWidget extends StatefulWidget {
  const ComentarioCancelacionWidget({
    super.key,
  ...
  @override
  State<ComentarioCancelacionWidget> createState() =>
      _ComentarioCancelacionWidgetState();
}

class _ComentarioCancelacionWidgetState
    extends State<ComentarioCancelacionWidget> {
  late ComentarioCancelacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComentarioCancelacionModel());
          ...
          child: Form(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Agregar comentario sobre la orden',
